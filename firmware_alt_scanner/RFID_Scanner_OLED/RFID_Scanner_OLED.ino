/* Board: ProMicro 5V (from diymore.cc) */
// If difficulties to flash it:
// * shortcut GND & RST twice fast
// * Upload sketch (fast)
// * shortcut GND & RST twice fast
_Pragma ("ARDUINO_IDE_PREFS board=promicro")
_Pragma ("ARDUINO_IDE_PREFS custom_cpu=promicro_16MHzatmega32U4")
_Pragma ("ARDUINO_IDE_PREFS target_package=SparkFun")
_Pragma ("ARDUINO_IDE_PREFS target_platform=avr")
...
#include "src/OLEDSoftI2C_SSD1306/OLEDSoftI2C_SSD1306.h"
...
const char *getPICCname(MFRC522::PICC_Type piccType)
{
  switch (piccType) {
